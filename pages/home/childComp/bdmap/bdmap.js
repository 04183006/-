// 引用百度地图微信小程序JSAPI模块 
// iconPath: '../../../../assets/home/marker_red.png',
//   iconPathSelected: '../../../../assets/home/marker_yellow.png',
// var app = getApp();
// var amap = require('../../../../service/amap-wx.js');
// var key = "5ca6f79b70f828fbb02c1105c6ac4e1b";
//引入高德SDK
//引入高德SDK
var amapFile = require('../../../../service/amap-wx.js');
var key = "5ca6f79b70f828fbb02c1105c6ac4e1b";
var markersData = [];
Page({
  /**
  ...
  changeMarkerColor: function (data, i) {
    ...
    for (var j = 0; j < data.length; j++) {
      if (j == i) {
        data[j].iconPath = '../../../../assets/home/marker_yellow.png';
      } else {
        data[j].iconPath = '../../../../assets/home/marker_red.png';
      }
      markers.push({
        id: data[j].id,
